    ...
    <div className={`${poppins.className} min-h-screen bg-white text-[#1D1D1F] selection:bg-[#40BB43] selection:text-white overflow-x-hidden`}>
      ...
      <nav className="fixed w-full top-0 bg-white/80 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-20 flex items-center justify-between">
            {/* Logo - Ajuste de largura para mobile */}
            ...
            <div className="flex gap-2 md:gap-3 items-center">
                {/* --- BOTÃO LOGIN BAR --- */}
                {/* Agora visível em mobile com ajuste de tamanho */}
                <Link href="/bartender/login">
                    <button className="px-3 py-1.5 text-xs md:px-5 md:py-2.5 md:text-sm font-bold text-gray-600 border border-gray-200 rounded-full hover:border-[#40BB43] hover:text-[#40BB43] transition-all whitespace-nowrap">
                        Login Bar
                    </button>
                </Link>
                ...
                <Link href="/organizador/login">
                    <button className="px-3 py-1.5 text-xs md:px-6 md:py-2.5 bg-[#40BB43] hover:bg-[#36a539] text-white md:text-sm font-bold rounded-full shadow-lg shadow-green-200 transition-all active:scale-95 whitespace-nowrap">
                        Criar Evento
                    </button>
                </Link>
            </div>
